      ...
      <ul class="d-flex flex-column gap-0">
        ...
        <?php if($role === 'admin'): ?>
          <li class="nav-item <?php echo e(activeRoute('ventas.create')); ?>">
            <a href="<?php echo e(route('ventas.create')); ?>" class="d-flex align-items-center px-3 py-2 rounded">
          ...
          <li class="nav-item <?php echo e(activeRoute(['ventas.index', 'ventas.show', 'ventas.detalle', 'ventas.devolucion', 'ventas.factura*'])); ?>">
            <a href="<?php echo e(route('ventas.index')); ?>" class="d-flex align-items-center px-3 py-2 rounded">
              <span class="icon fs-5 me-3">
          ...
          <li class="nav-item <?php echo e(activeRoute(['productos.index', 'productos.create'])); ?>">
            <a href="<?php echo e(route('productos.index')); ?>" class="d-flex align-items-center px-3 py-2 rounded">
              <span class="icon fs-5 me-3">
          ...
          <li class="nav-item <?php echo e(activeRoute('reportes.index')); ?>">
            <a href="<?php echo e(route('reportes.index')); ?>" class="d-flex align-items-center px-3 py-2 rounded">
              <span class="icon fs-5 me-3">
          ...
          <li class="nav-item <?php echo e(activeRoute(['clientes.index', 'clientes.show'])); ?>">
          ...
          <li class="nav-item <?php echo e(activeRoute(['ajustes.index', 'empresa.index', 'db.index', 'licencia.index', 'configuracion.devoluciones', 'auditoria.index'])); ?>">
...
<?php /**PATH C:\OptenAdvance\app\www\resources\views/layouts/app.blade.php ENDPATH**/ ?>