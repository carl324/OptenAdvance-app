        ...
        <div class="col-md-6">
          <div class="breadcrumb-wrapper">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo e(route('ventas.create')); ?>">Inicio</a></li>
                  ...
                  <tr data-id="<?php echo e($cliente->id); ?>">
                    ...
                    <td class="min-width">
                      <p class="text-sm mb-0">
                        <?php echo e($cliente->cupo_credito > 0 ? '$'.number_format($cliente->cupo_credito) : 'Sin límite'); ?>
                    ...
                    <td class="min-width">
                      <?php if($cliente->saldo_pendiente > 0): ?>
                        <span class="badge" style="background:#fee2e2;color:#b91c1c;padding:5px 10px;border-radius:20px;font-size:12px;font-weight:600;">
                          $<?php echo e(number_format($cliente->saldo_pendiente)); ?>
                      ...
                      <div class="action justify-content-end">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                          <li class="dropdown-item">
                            <a href="<?php echo e(route('clientes.show', $cliente->id)); ?>" class="text-gray">
                              <i class="lni lni-eye me-2"></i> Ver detalle
                            </a>
                          </li>
                          <li class="dropdown-item">
                            <button class="text-gray border-0 bg-transparent p-0 w-100 text-start" onclick="abrirModalEditar(<?php echo e($cliente->id); ?>, '<?php echo e(addslashes($cliente->nombre)); ?>', '<?php echo e($cliente->telefono); ?>', '<?php echo e($cliente->nit); ?>', '<?php echo e($cliente->email); ?>', '<?php echo e(addslashes($cliente->direccion)); ?>', <?php echo e($cliente->cupo_credito); ?>)">
                              <i class="lni lni-pencil me-2"></i> Editar
                            </button>
                          </li>
                          <li class="dropdown-item">
                            <button class="text-danger border-0 bg-transparent p-0 w-100 text-start" onclick="confirmarEliminar(<?php echo e($cliente->id); ?>, '<?php echo e(addslashes($cliente->nombre)); ?>')">
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.getElementById('buscador').addEventListener('input', function () {
    ...
    timer = setTimeout(() => {
      ...
      window.location.href = '<?php echo e(route("clientes.index")); ?>?search=' + encodeURIComponent(q);
    }, 400);
  });
});
