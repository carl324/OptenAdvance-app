  ...
  <script>
    (function () {
      ...
      async function loadResumen() {
        ...
        clearError(main);
        try {
          const res = await fetch('<?php echo e(route('caja.cierre.resumen')); ?>', { headers: { Accept: 'application/json' } });
      ...
      function bindConfirm() {
        ...
        btn.addEventListener('click', async function () {
          ...
          try {
            ...
            const res = await fetch('<?php echo e(route('caja.cerrar')); ?>', {
              method: 'POST',
              headers: {
...
</html><?php /**PATH C:\Users\User\Documents\optenadvance\laragon\www\optenadvance\resources\views/layouts/app.blade.php ENDPATH**/ ?>