        ...
        <div class="card-style mb-30">
          ...
          <div id="campos-cliente" style="border-top:1px solid #f1f5f9;padding-top:20px;">
            ...
            <div class="d-flex justify-content-between align-items-center mb-15">
              ...
              <span class="text-sm fw-semibold campo-ver" id="ver-cupo">
                <?php echo e($cliente->cupo_credito > 0 ? '$'.number_format($cliente->cupo_credito, 0, ',', '.') : 'Sin límite'); ?>

              </span>
              <input class="campo-editar" id="edit-cupo"
                     value="<?php echo e($cliente->cupo_credito > 0 ? number_format($cliente->cupo_credito, 0, ',', '.') : ''); ?>"
                     placeholder="0"
          ...
          <div style="background:#f8fafc;border-radius:12px;padding:16px;margin-top:10px;">
            ...
            <div class="d-flex justify-content-between mb-10">
              ...
              <span class="text-sm fw-semibold">$<?php echo e(number_format($totalComprado, 0, ',', '.')); ?></span>
            </div>
            <div class="d-flex justify-content-between mb-10">
              <span class="text-sm text-gray">Total abonado</span>
              <span class="text-sm fw-semibold" style="color:#16a34a;">$<?php echo e(number_format($totalAbonado, 0, ',', '.')); ?></span>
            </div>
            <div style="border-top:1px solid #e2e8f0;padding-top:10px;" class="d-flex justify-content-between">
              ...
              <span class="fw-semibold" style="color:<?php echo e($cliente->saldo_pendiente > 0 ? '#dc2626' : '#16a34a'); ?>;font-size:15px;">
