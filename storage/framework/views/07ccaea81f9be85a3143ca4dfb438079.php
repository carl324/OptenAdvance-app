...
<?php $__env->startSection('title', 'Configuración de devoluciones'); ?>
                ...
                <div class="card-style mb-30">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <input type="number" id="dias_devolucion" class="form-control" 
                            value="<?php echo e($diasDevolucion); ?>" min="1" max="365"
            ...
            <div class="col-lg-7">
                <div class="card-style mb-30">
                    ...
                    <div id="lista-motivos">
                        <?php $__empty_1 = true; $__currentLoopData = $motivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $motivo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="motivo-item d-flex align-items-center justify-content-between gap-2 py-2" 
                             style="border-bottom:1px solid #f1f5f9;" id="motivo-<?php echo e($motivo->id); ?>">
                            
                            
                            <div class="d-flex align-items-center gap-2 flex-fill vista-normal-<?php echo e($motivo->id); ?>">
                                <span class="text-sm <?php echo e(!$motivo->activo ? 'text-gray' : ''); ?>" 
                                      style="<?php echo e(!$motivo->activo ? 'text-decoration:line-through;' : ''); ?>">
                            ...
                            <div class="d-none flex-fill vista-edicion-<?php echo e($motivo->id); ?>">
                                <input type="text" class="form-control form-control-sm" 
                                    id="editar-nombre-<?php echo e($motivo->id); ?>" value="<?php echo e($motivo->nombre); ?>" maxlength="100">
                                <div id="error-editar-<?php echo e($motivo->id); ?>" class="text-danger small mt-1 d-none"></div>
                            </div>

                            
                            <div class="d-flex gap-1 botones-normal-<?php echo e($motivo->id); ?>">
                                <button onclick="activarEdicion(<?php echo e($motivo->id); ?>)" 
                                    class="btn btn-light btn-sm" title="Editar">
                                    <i class="lni lni-pencil"></i>
                                </button>
                                <button onclick="toggleMotivo(<?php echo e($motivo->id); ?>, <?php echo e($motivo->activo ? 'true' : 'false'); ?>)" 
                                    class="btn btn-light btn-sm" title="<?php echo e($motivo->activo ? 'Desactivar' : 'Activar'); ?>">
                                    <i class="lni <?php echo e($motivo->activo ? 'lni-eye' : 'lni-eye'); ?>"></i>
                                </button>
                                <button onclick="eliminarMotivo(<?php echo e($motivo->id); ?>)" 
                                    class="btn btn-light btn-sm text-danger" title="Eliminar">
                                    <i class="lni lni-trash-can"></i>
                                </button>
                            </div>

                            <div class="d-none gap-1 botones-edicion-<?php echo e($motivo->id); ?>">
                                <button onclick="guardarEdicion(<?php echo e($motivo->id); ?>)" 
                                    class="btn btn-sm main-btn primary-btn btn-hover">
                                    <i class="lni lni-checkmark"></i>
                                </button>
                                <button onclick="cancelarEdicion(<?php echo e($motivo->id); ?>)" 
...
async function guardarDias() {
    ...
    try {
        const res = await fetch('<?php echo e(route("configuracion.dias")); ?>', {
            method: 'POST',
...
async function guardarNuevoMotivo() {
    ...
    try {
        const res = await fetch('<?php echo e(route("motivos-devolucion.store")); ?>', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': CSRF, 'Accept': 'application/json' },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\OptenAdvance\app\www\resources\views\ajustes\devoluciones.blade.php ENDPATH**/ ?>