                ...
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center me-4">
                        <div class="text-end">
                            ...
                            <p class="session-email mb-0">{{ Auth::user()->email }}</p>
                        </div>
                    </div>
                    <form method="POST" action="{{ route('superadmin.logout') }}" id="logoutForm">
                        @csrf
    ...
    <div class="container-xl py-5">
        <div class="row g-4">
            ...
            <div class="col-lg-7">
                ...
                <div class="card-main">
                    <form method="POST" action="{{ route('superadmin.reset.password') }}" id="resetForm">
                        @csrf
    ...
    <script>
        ...
        @if (session('success'))
            document.addEventListener('DOMContentLoaded', function() {
                showSuccessModal({!! json_encode(session('success')) !!});
            });
        @endif

        @if (session('error'))
            document.addEventListener('DOMContentLoaded', function() {
                showErrorModal({!! json_encode(session('error')) !!});
            });
        @endif
