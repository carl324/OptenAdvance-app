        ...
        <div class="card-style" style="padding: 20px 24px;">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <input type="date" id="filtro-desde" value="{{ request('desde') }}"
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <input type="date" id="filtro-hasta" value="{{ request('hasta') }}"
                        class="form-control filtro-auditoria"
                        style="height:38px; border-radius:6px; border:1px solid #e5e5e5; padding:0 12px; font-size:13px; width:100%; background:#fafafa;" />
                </div>
...
function cargarResultados(pagina = 1) {
    ...
    fetch(`{{ route('auditoria.index') }}?${params.toString()}`, {
...
function renderTabla(registros) {
    ...
    function renderTimeline(registros) {
        ...
        const tiposAccion = @json($tiposAccion);
...
renderPaginacion(
    ...
    {{ $registros->lastPage() }},
    {{ $registros->firstItem() ?? 0 }},
    {{ $registros->lastItem() ?? 0 }},
    {{ $registros->total() }}
);
